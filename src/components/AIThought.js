...
const AIThought = ({ aiThought, onContinue }) => (
  <div className="card shadow p-4 m-auto rounded-4 border-0 text-center mb-4 profile-form-card ai-thought-card">
    ...
    <button
      className="btn btn-primary w-100 ai-thought-btn"
      onClick={onContinue}
    >
      Continue
    </button>
